                                        ...
                                        <form action="{{route('authenticate')}}" method="POST">
                                          @csrf
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" name="username" type="text" placeholder="Email address or Username" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small text-secondary" href="{{route('forgot_password')}}" style="text-decoration: none">Lupa kata sandi?</a>
